...
**The-Starry-List** 是面向 Minecraft 26.2.x Fabric 的可扩展服务端排行榜模组，提供六个内置榜单、玩家独立侧边栏设置、管理员工具、黑名单和可热重载的 Groovy 榜单。
...
此构建面向 Minecraft 26.2.x 版本线。请下载与你所用 Minecraft 版本线对应的模组构建；不保证同一个 JAR 能跨游戏版本通用。

Minecraft 26.2.x 构建需要 Java 25+、Fabric Loader 0.19.3 或兼容版本，以及 Fabric API 0.157.0+26.2 或兼容版本。Cloth Config 与 ModMenu 均为可选依赖，只用于提供本地的图形化配置界面。
